            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="/databasket">Basket</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="{{ asset('fotobasket/'.$or->foto)}}">
                                    <p>{{ $or->nama }}</p>
                                </td>
                                <td>{{ $or->ttl }}</td>
                                <td>{{ $or->nik }}</td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/deletebasket/{{$or->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="ModalView{{$or->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('fotobasket/'.$or->foto)}}" class="rounded mx-auto d-block" style="max-height: 350px;" alt="Foto">
                    <form action="{{ route('admin/updatedatabasket', ['id' => $or->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/insertbasket" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Foto</label>
                            <input type="file" name="foto" class="form-control">
